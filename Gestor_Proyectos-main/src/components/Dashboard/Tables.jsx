        ...
        <div className="app">
          <div className="datos">
            ...
            <div className="col-span-2 sm:col-span-1">
              <label htmlFor="rol" className="block text-sm font-medium text-white">Rol</label>
              <select
                onChange={(event) => {
                  setRol(event.target.value.trim());
                  setErrorMessage('');
                }}
                id="rol" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5  dark:focus:ring-primary-500 dark:focus:border-primary-500">
            ...
            <div className="col-span-2">
              ...
              <select
                ...
                id="team" className="bg-gray-50 border border-gray-300 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 text-black dark:focus:ring-primary-500 dark:focus:border-primary-500">
            ...
            <button className='hover:bg-red-700 hover:text-white' onClick={actualizarUsuario}>Editar</button>
          </div>
        </div>
      )}
