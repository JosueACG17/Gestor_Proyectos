                ...
                <div id="crud-modal" aria-hidden="true" className=" fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center bg-white">
                    <div className="bg-green-700 ml-20 w-full max-w-md p-6 rounded-lg shadow-md ">
                        ...
                        <form className="grid gap-4 grid-cols-1">
                            <div className="grid gap-4 mb-4 grid-cols-2">
                                <div className="col-span-2">
                                    <label for="name" className="block mb-2 text-sm font-medium text-white">Nombre Proyecto</label>
                                ...
                                <div className="col-span-2 sm:col-span-1">
                                    <label for="category" className="block mb-2 text-sm font-medium text-white">Estado</label>
                                    <select id="category" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5  dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                        <option selected="">Selecciona un estado</option>
                                        <option value="TV">Disponible</option>
                                        <option value="PC">No Disponible</option>
                                    </select>
                                </div>
                                <div className="col-span-2">
                        ...
                        <button type="submit" className="mt-2 flex items-center justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            ...
                            <span className="ms-2">Editar Proyecto</span>
                        </button>
